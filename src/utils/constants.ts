...
export const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    description: 'Make smarter, data-informed hiring choices with comprehensive candidate evaluations.',
...
export const COMPANY_INFO = {
  name: 'TalentFlow',
  tagline: 'Elevate Your Hiring Process With Efficient, Intelligent and Data-Backed Innovation',
  description: 'Manage the full recruitment cycle seamlessly from candidate discovery to onboarding with a platform built for smarter, equitable hiring.',
};
