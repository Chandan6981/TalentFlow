          ...
          <div>
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="px-4 sm:py-2 py-1 text-gray-900 border cursor-pointer  border-gray-300 rounded-lg hover:bg-gray-50 hover:text-indigo-500 "
              >
                Back
              </button>
            </div>
        ...
        <div className="flex sm:flex-row flex-col gap-5 justify-between items-center">
          ...
          <div className="flex space-x-3 text-nowrap">
            ...
            <button
              ...
              className="px-4 py-2 w-full cursor-pointer bg-indigo-600 text-white rounded-lg hover:bg-indigo-700"
            >
              Submit
            </button>
          </div>
