...
const HrDashboard = () => {
  ...
  const StatCard = ({
    ...
    <div className="bg-white border border-indigo-300 rounded-lg shadow-sm p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xs font-semibold text-indigo-600/70">
              {" "}
              {subtitle}
            </p>
          </div>
        ...
        <div className="text-right">
          ...
          {/* {trend && <div className="text-sm text-indigo-600">{trend}</div>} */}
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            ...
            className="bg-white rounded-lg shadow-sm border border-indigo-300 p-6 hover:shadow-md transition-shadow cursor-pointer"
          >
            <div className="flex items-center">
      ...
      {/* Recent Activity */}
      <div className="bg-white rounded-lg shadow-sm border border-indigo-300 p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">
          Recent Activity
        </h2>
