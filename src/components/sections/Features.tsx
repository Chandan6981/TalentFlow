      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Simplify Your Entire Hiring Process End-to-End
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Advanced tools crafted to streamline your recruitment workflow from start to finish.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURES.map((feature, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 bg-indigo-600 text-white">
              ...
              {index === 0 && (
                <div className="mt-6 bg-indigo-600 rounded-xl p-1 text-white">
                  <div className="bg-white rounded-lg p-4 text-left">
                    ...
                    <p className="text-xs text-gray-600 mb-2">
                      Lead end-to-end software development lifecycle from requirements and system design to implementation, testing, and deployment.
                    </p>
              ...
              {index === 1 && (
                <div className="mt-6 bg-indigo-100 rounded-xl p-6">
