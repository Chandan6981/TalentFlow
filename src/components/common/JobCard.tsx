...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  ...
  return (
    <Card className="hover:shadow-lg transition-all duration-300 border hover:border-indigo-200 cursor-pointer group">
      <div onClick={handleJobCardClick} className="flex items-start space-x-4">
        {/* Job Type Avatar */}
        <div className="w-12 h-12 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="flex-grow min-w-0">
          <div className="flex items-start justify-between mb-2">
            <div>
              <h3 className="font-semibold text-gray-900 md:text-lg sm:text-base text-sm group-hover:text-indigo-600 transition-colors">
                {job.title}
              </h3>
